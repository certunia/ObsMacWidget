...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        __designTimeSelection(Text(__designTimeString("#3232.[5].[0].property.[0].[0].arg[0].value", fallback: "Settings here. GHHH"))
            .padding(), "#3232.[5].[0].property.[0].[0]")
...
extension AppDelegate {
    @_dynamicReplacement(for: applicationDidFinishLaunching(_:)) private func __preview__applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        __designTimeSelection(print(__designTimeString("#3232.[4].[3].[2].arg[0].value", fallback: "asdffaa")), "#3232.[4].[3].[2]")
